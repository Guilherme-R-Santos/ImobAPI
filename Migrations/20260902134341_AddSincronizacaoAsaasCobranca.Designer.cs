...
namespace ImobAPI.Migrations
{
    ...
    [Migration("20260902134341_AddSincronizacaoAsaasCobranca")]
    partial class AddSincronizacaoAsaasCobranca
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImobAPI.Entities.Cobranca", b =>
                {
                    ...
                    b.Property<string>("ErroSincronizacaoAsaas")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IdCobrancaAsaas")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("SincronizadoAsaas")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ImobAPI.Entities.Finalidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ImobAPI.Entities.Imovel", b =>
                {
                    ...
                    b.HasOne("ImobAPI.Entities.Finalidade", "Finalidade")
                        .WithMany()
